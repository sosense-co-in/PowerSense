                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="view_tickets" name="permissions[]" value="view_tickets"
                                                            {{ $role->hasPermissionTo('view tickets') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="view tickets">View
                                                            Tickets</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="create tickets" name="permissions[]"
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="edit tickets" name="permissions[]" value="edit_tickets"
                                                            {{ $role->hasPermissionTo('edit tickets') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="edit tickets">Edit
                                                            Tickets</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="delete tickets" name="permissions[]"
                                                            value="delete_tickets"
                                                            {{ $role->hasPermissionTo('delete tickets') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="delete tickets">Delete
                                                            Tickets</label>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="assign_ticket" name="permissions[]" value="assign_ticket"
                                                            {{ $role->hasPermissionTo('assign_ticket') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="assign_ticket">Assign Tickets</label>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="update_ticket_status" name="permissions[]" value="update_ticket_status"
                                                            {{ $role->hasPermissionTo('update_ticket_status') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="update_ticket_status">update Tickets</label>
                                                    </div>
                                                </div>
