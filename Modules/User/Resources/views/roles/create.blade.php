                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="view_account" name="permissions[]" value="view_account"
                                                            {{ old('view_account') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="view_account">View
                                                            </label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="create_account">Create
                                                            </label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="edit_account" name="permissions[]" value="edit_account"
                                                            {{ old('edit_account') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="edit_account">Edit
                                                            </label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            {{ old('delete_account') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="delete_account">Delete
                                                            </label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="download_account" name="permissions[]"
                                                            value="download_account"
                                                            {{ old('download_account') ? 'checked' : '' }}>
                                                        <label class="custom-control-label"
                                                            for="download_account">Download </label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="view_contact" name="permissions[]" value="view_contact"
                                                            {{ old('view_contact') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="view_contact">View
                                                            </label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="create_contact" name="permissions[]"
                                                            value="create_contact"
                                                            {{ old('create_contact') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="create_contact">Create
                                                            </label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="edit_contact" name="permissions[]" value="edit_contact"
                                                            {{ old('edit_contact') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="edit_contact">Edit
                                                            </label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            {{ old('delete_contact') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="delete_contact">Delete
                                                            </label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="download_contact" name="permissions[]"
                                                            value="download_contact"
                                                            {{ old('download_contact') ? 'checked' : '' }}>
                                                        <label class="custom-control-label"
                                                            for="download_contact">Download </label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-6 mb-3">
                                    <div class="card h-100 border-0 shadow">
                                        <div class="card-header">AMC Contracts</div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="view_amc" name="permissions[]" value="view_amc"
                                                            {{ old('view_amc') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="view_amc">View
                                                            </label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="create_amc" name="permissions[]" value="create_amc"
                                                            {{ old('create_amc') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="create_amc">Create
                                                            </label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="edit_amc" name="permissions[]" value="edit_amc"
                                                            {{ old('edit_amc') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="edit_amc">Edit
                                                            </label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="delete_amc" name="permissions[]" value="delete_amc"
                                                            {{ old('delete_amc') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="delete_amc">Delete
                                                            </label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="download_amc" name="permissions[]" value="download_amc"
                                                            {{ old('download_amc') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="download_amc">Download
                                                            </label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="create_tickets" name="permissions[]"
                                                            value="create tickets"
                                                            {{ old('create tickets') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="create_tickets">Create
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="view_tickets" name="permissions[]" value="view tickets"
                                                            {{ old('view tickets') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="view_tickets">View
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="edit_tickets" name="permissions[]" value="edit tickets"
                                                            {{ old('edit tickets') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="edit_tickets">Edit
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="delete_tickets" name="permissions[]"
                                                            value="delete tickets"
                                                            {{ old('delete tickets') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="delete_tickets">Delete
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="reply_tickets" name="permissions[]" value="reply tickets"
                                                            {{ old('reply tickets') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="reply_tickets">Reply to
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="manage_tickets">Manage
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
