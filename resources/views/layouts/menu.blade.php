...
@endcan
@can('view_account')
    <li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('account.*') ? 'c-show' : '' }}">
        <a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
            <i class="c-sidebar-nav-icon bi bi-person"></i>
            <span>Accounts</span>
        </a>
        <ul class="c-sidebar-nav-dropdown-items">
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link {{ request()->routeIs('account.index') ? 'c-active' : '' }}"
                    href="{{ route('account.index') }}">
                    <i class="c-sidebar-nav-icon bi bi-journals" style="line-height: 1;"></i> All Accounts
                </a>
            </li>
            @can('create_account')
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link {{ request()->routeIs('account.create') ? 'c-active' : '' }}"
                        href="{{ route('account.create') }}">
                        <i class="c-sidebar-nav-icon bi bi-journal-plus" style="line-height: 1;"></i> Create Account
                    </a>
                </li>
            @endcan
        </ul>
...
@can('view_contact')
    <li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('contact.*') ? 'c-show' : '' }}">
        <a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
            <i class=" c-sidebar-nav-icon bi bi-person-check"></i>
            <span>Contacts</span>
        </a>
        <ul class="c-sidebar-nav-dropdown-items">
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link {{ request()->routeIs('contact.index') ? 'c-active' : '' }}"
                    href="{{ route('contact.index') }}">
                    <i class="c-sidebar-nav-icon bi bi-journals" style="line-height: 1;"></i> All Contacts
                </a>
            </li>
            @can('create_contact')
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link {{ request()->routeIs('contact.create') ? 'c-active' : '' }}"
                        href="{{ route('contact.create') }}">
                        <i class="c-sidebar-nav-icon bi bi-journal-plus" style="line-height: 1;"></i> Create Contact
                    </a>
                </li>
            @endcan
        </ul>
...
@can('view_amc')
    <li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('amc-contracts.*') ? 'c-show' : '' }}">
        <a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
            <i class="c-sidebar-nav-icon bi bi-file-earmark-text"></i>
            <span>AMC Contracts</span>
        </a>
        <ul class="c-sidebar-nav-dropdown-items">
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link {{ request()->routeIs('amc-contracts.index') ? 'c-active' : '' }}"
                    href="{{ route('amc-contracts.index') }}">
                    <i class="c-sidebar-nav-icon bi bi-journals" style="line-height: 1;"></i> All AMC Contracts
                </a>
            </li>
            @can('create_amc')
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link {{ request()->routeIs('amc-contracts.create') ? 'c-active' : '' }}"
                        href="{{ route('amc-contracts.create') }}">
                        <i class="c-sidebar-nav-icon bi bi-journal-plus" style="line-height: 1;"></i> Create AMC Contract
                    </a>
                </li>
            @endcan
        </ul>
...
@can('access_tickets')
    <li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('tickets.*') ? 'c-show' : '' }}"">
        <a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
            <i class="c-sidebar-nav-icon bi bi-receipt" style="line-height: 1;"></i> Tickets
        </a>
        <ul class="c-sidebar-nav-dropdown-items">
            @can('create_tickets')
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link {{ request()->routeIs('tickets.create') ? 'c-active' : '' }}"
            ...
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link {{ request()->routeIs('tickets.index') ? 'c-active' : '' }}"
                    ...
                    <i class="c-sidebar-nav-icon bi bi-journals" style="line-height: 1;"></i> All Tickets
                </a>
            </li>
        </ul>
    </li>
