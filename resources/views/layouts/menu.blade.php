...
<li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('tickets.*') ? 'c-show' : '' }}"">
    ...
    <ul class="c-sidebar-nav-dropdown-items">
        @can('create_tickets')
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link {{ request()->routeIs('tickets.create') ? 'c-active' : '' }}" href="{{ route('tickets.create') }}">
                    <i class="c-sidebar-nav-icon bi bi-journal-plus" style="line-height: 1;"></i> Create Ticket
                </a>
            </li>
        @endcan
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->routeIs('tickets.index') ? 'c-active' : '' }}" href="{{ route('tickets.index') }}">
