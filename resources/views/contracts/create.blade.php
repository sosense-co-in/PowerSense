            ...
            <form action="{{ route('amc-contracts.store') }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="" name="ref_no" class="form-control" id="ref_no"
                                        value="{{ $refNo ?? '0000' }}" readonly>
                                    @if ($errors->has('ref_no'))
                                        <p class="help-block">{{ $errors->first('ref_no') }}</p>
                                    @endif
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="type" id="type" class="form-control">
                                        <option value="comp" {{ old('type') == 'comp' ? 'selected' : '' }}>Comprehensive
                                        </option>
                                        <option value="non_comp" {{ old('type') == 'non_comp' ? 'selected' : '' }}>Non
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="wrapper" id="wrp" style="display: none;">
                                        <a href="javascript:void(0);" id="account" class="font-weight-300"
                                            onclick="openAccountForm();">+ Add New Account</a>
                                    </div>
                ...
                <div class="card mb-2">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <h6>Company Authorized Signatory Details</h6>
                                <hr>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="own_auth_sign_name">Authority Name </label>
                                    <input id="own_auth_sign_name" value="{{ old('own_auth_sign_name') }}"
                                        placeholder="Name" class="form-control" type="text" name="own_auth_sign_name">
                                    @if ($errors->has('own_auth_sign_name'))
                                        <p class="text-danger">{{ $errors->first('own_auth_sign_name') }}</p>
                                    @endif
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="own_auth_sign_desn" class="form-control"
                                        value="{{ old('own_auth_sign_desn') }}" placeholder="Designation" type="text"
                                        name="own_auth_sign_desn">
                                    @if ($errors->has('own_auth_sign_desn'))
                                        <p class="text-danger">{{ $errors->first('own_auth_sign_desn') }}</p>
                                    @endif
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="own_auth_sign_mobile" placeholder="Contact No"
                                        value="{{ old('own_auth_sign_mobile') }}" class="form-control" type="text"
                                        name="own_auth_sign_mobile">
                                    @if ($errors->has('own_auth_sign_mobile'))
                                        <p class="text-danger">{{ $errors->first('own_auth_sign_mobile') }}</p>
                                    @endif
                                </div>
                            </div>

                            <div class="col-md-12">
                                <h6> Customer's Authorized Signatory Details</h6>
                                <hr>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="cust_auth_sign_name">Authority Name </label>
                                    <input id="cust_auth_sign_name" placeholder="Name" class="form-control"
                                        value="{{ old('cust_auth_sign_name') }}" type="text"
                                        name="cust_auth_sign_name">
                                    @if ($errors->has('cust_auth_sign_name'))
                                        <p class="text-danger">{{ $errors->first('cust_auth_sign_name') }}</p>
                                    @endif
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="cust_auth_sign_desn" class="form-control" placeholder="Designation"
                                        type="text" value="{{ old('cust_auth_sign_desn') }}"
                                        name="cust_auth_sign_desn">
                                    @if ($errors->has('cust_auth_sign_desn'))
                                        <p class="text-danger">{{ $errors->first('cust_auth_sign_desn') }}</p>
                                    @endif
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row toclone">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="product_items" class="form-control" type="text"
                                            name="product_items[]" value="{{ old('product_items.0') }}"
                                            placeholder="Product Description">
                                        @if ($errors->has('product_items.0'))
                                            <p class="text-danger">{{ $errors->first('product_items.0') }}</p>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-sm-3 cost">
                                    <div class="form-group ">
                                        ...
                                        <input id="hsn" class="form-control cpu" type="text" name="hsn[]"
                                            value="{{ old('hsn.0') }}" placeholder="HSN Code">
                                        @if ($errors->has('hsn.0'))
                                            <p class="text-danger">{{ $errors->first('hsn.0') }}</p>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-sm-3 cost">
                                    <div class="form-group ">
                                        ...
                                        <input id="rating" class="form-control cpu" type="text" name="rating[]"
                                            value="{{ old('rating.0') }}" placeholder="Rating or Capacity">
                                        @if ($errors->has('rating.0'))
                                            <p class="text-danger">{{ $errors->first('rating.0') }}</p>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3 cost">
                                    <div class="form-group ">
                                        ...
                                        <input id="sr_no" class="form-control cpu" type="text" name="sr_no[]"
                                            value="{{ old('sr_no.0') }}" placeholder="Sr. No.">
                                        @if ($errors->has('sr_no.0'))
                                            <p class="text-danger">{{ $errors->first('sr_no.0') }}</p>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-sm-2 qty">
                                    <div class="form-group">
                                        ...
                                        <input id="cost_per_unit" class="form-control" type="text"
                                            name="cost_per_unit[]" value="{{ old('cost_per_unit.0') }}"
                                            placeholder="cost_per_unit" onkeyup="getId(this)">
                                        @if ($errors->has('cost_per_unit.0'))
                                            <p class="text-danger">{{ $errors->first('cost_per_unit.0') }}</p>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <input id="quantity" class="form-control" type="text" name="quantity[]"
                                            value="{{ old('quantity.0') }}" placeholder="quantity"
                                            onkeyup="getId(this)">
                                        @if ($errors->has('quantity.0'))
                                            <p class="text-danger">{{ $errors->first('quantity.0') }}</p>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <input id="total_cost" class="form-control" type="text" name="total_cost[]"
                                            value="{{ old('total_cost.0') }}" placeholder="total_cost" >
                                        @if ($errors->has('total_cost.0'))
                                            <p class="text-danger">{{ $errors->first('total_cost.0') }}</p>
                                        @endif
                                    </div>
                                </div>
                                {{-- <div class="col-sm-2"> --}}
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="taxes" placeholder="Taxes" class="form-control"
                                        value="{{ old('taxes') }}" type="text" name="taxes">
                                    @if ($errors->has('taxes'))
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="payment" placeholder="Payment Terms" class="form-control"
                                        value="{{ old('payment') }}" type="text" name="payment">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="validity" placeholder="In days" class="form-control"
                                        value="{{ old('validity') }}" type="text" name="validity">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input id="contract_start" placeholder="Contract Start Date"
                                        class="form-control datepicker" value="{{ old('contract_start') }}"
                                        type="text" name="contract_start">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input id="contract_end" placeholder="Contract End Date"
                                        class="form-control datepicker" value="{{ old('contract_end') }}" type="text"
                                        name="contract_end">
                                    @if ($errors->has('contract_end'))
                                        <p class="text-danger">{{ $errors->first('contract_end') }}</p>
                                    @endif
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <button type="submit" class="btn btn-primary float-right btn-sm">Submit</button>
                                <a href="{{ route('amc-contracts.index') }}"
                                    class="btn btn-sm btn-secondary float-right m-r-5">Back</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        $(document).ready(function() {
            ...
            $('#search-account').on("select2:open", function() {
                ...
                if (flg == 1) {
                    ...
                    $(".select2-results").append("<div class='select2-results__option'>" + $this_html +
                        "</div>");
                }
            });
